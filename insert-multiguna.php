...
//$sql = "INSERT INTO `rf_kta` (`applicant_name`, `mobile_number`, `email`, `company_name`, `company_address`, `job`, `earnings_per_month`, `bpkb`, `created_dttm`, `lastupd_user`, `lastupd_dttm`) VALUES ('cuy', '0812313', 'PT Angin Ribut', 'Jalan Sudirman', 'CEO', '30000000', 'BRI, BNI', CURRENT_TIMESTAMP, 'RAMU.USER', CURRENT_TIMESTAMP)";

$sql = "INSERT INTO `rf_multiguna` (`applicant_name`, `mobile_number`, `email`, `company_name`, `company_address`, `job`, `earnings_per_month`, `bpkb`, `declaration`,`created_dttm`, `lastupd_user`, `lastupd_dttm`) VALUES ('" .$applicant_name. "', '" .$mobile_number. "', '" .$email. "', '".$company_name. "', '" .$company_address. "', '" .$job. "', '" .$earnings_per_month. "', '" .$bpkb. "', '" .$declaration. "', CURRENT_TIMESTAMP, 'RAMU.USER', CURRENT_TIMESTAMP)";
...
<body>
  ...
  <main id="main">
      <!-- ======= Status Submit Kredit Multiguna Section ======= -->
...
<?php
	if ($conn->query($sql) === TRUE) {		
          echo "<h2>Formulir Kredit Multiguna Telah Berhasil Di-Submit. Staff kami akan menghubungi Anda. Terima kasih sudah menggunakan Ramusen.</h2><br><br><a href=\"index.php\" style=\"color:rgb(255, 204, 0)\">Klik Disini</a> untuk kembali ke halaman utama.";
	}else{
...
?>		
    ...
    </section><!-- End Submit Kredit Multiguna Section -->
  </main><!-- End #main -->
...
*/
    ...
    $to       = $email;
    $subject  = "Pengajuan Kredit Multiguna dari Ramusen - " .$applicant_name ;
	$message = "
<html>
<head>
<title>" .$subject. "</title>
