...
function smtp_mail($to, $subject, $message, $from_name, $from, $cc, $bcc, $debug=false) {
  ...
  $mail->SMTPAuth 	= true;                        				
  $mail->Host 		  = 'mail.ramusen.com';  // Masukkan Server SMTP
  $mail->Port 		  = 587;                                      // Masukkan Port SMTP
  $mail->SMTPSecure = 'tls';                                    // Masukkan Pilihan Enkripsi ( `tls` atau `ssl` )
  $mail->Username 	= 'noreply@ramusen.com';                // Masukkan Email yang digunakan selama proses pengiriman email via SMTP
  $mail->Password 	= '@noreply.12345';        						          // Masukkan Password dari Email tsb
  $default_email_from       = 'noreply@ramusen.com';        // Masukkan default from pada email
  $default_email_from_name  = 'Ramusen';           // Masukkan default nama dari from pada email
