...
//$sql = "INSERT INTO `rf_kta` (`applicant_name`, `mobile_number`, `email`, `company_name`, `company_address`, `job`, `earnings_per_month`, `owned_kta`, `created_dttm`, `lastupd_user`, `lastupd_dttm`) VALUES ('cuy', '0812313', 'PT Angin Ribut', 'Jalan Sudirman', 'CEO', '30000000', 'BRI, BNI', CURRENT_TIMESTAMP, 'RAMU.USER', CURRENT_TIMESTAMP)";

$sql = "INSERT INTO `rf_kta` (`applicant_name`, `mobile_number`, `email`, `company_name`, `company_address`, `job`, `earnings_per_month`, `owned_kta`, `declaration`,`created_dttm`, `lastupd_user`, `lastupd_dttm`) VALUES ('" .$applicant_name. "', '" .$mobile_number. "', '" .$email. "', '" .$company_name. "', '" .$company_address. "', '" .$job. "', '" .$earnings_per_month. "', '" .$owned_kta. "', '" .$declaration. "', CURRENT_TIMESTAMP, 'RAMU.USER', CURRENT_TIMESTAMP)";
...
<?php
	if ($conn->query($sql) === TRUE) {		
          echo "<h2>Formulir KTA Telah Berhasil Di-Submit. Staff kami akan menghubungi Anda. Terima kasih sudah menggunakan Ramusen.</h2><br><br><a href=\"index.php\" style=\"color:rgb(255, 204, 0)\">Klik Disini</a> untuk kembali ke halaman utama.";
	}else{
...
?>		
    ...
    </section><!-- End Submit KTA Section -->	
  </main><!-- End #main -->
...
*/
    ...
    $to       = $email;
    $subject  = "Pengajuan KTA dari Ramusen - " .$applicant_name ;
	$message = "
<html>
<head>
<title>" .$subject. "</title>
