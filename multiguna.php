  ...
  * License: https://bootstrapmade.com/license/
  ...
  <script>
    ...
    function validateMultiguna() {
      ...
      var codeMultiguna = document.forms["ktaForm"]["codeMultiguna"].value;

      var resultcaptchaMultiguna = document.forms["ktaForm"]["resultcaptchaMultiguna"].value;
...
<body>
    ...
    <section id="multiguna" class="contact">
      ...
      <div class="container">
        ...
        <div class="section-title">
          ...
          <img src="./assets/img/Rana-Multiguna-Instruction-Final.png" width="100%" height="100%">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
            ...
            <form id="ktaForm" action="insert-multiguna.php" method="post" class="php-email-form">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="bpkb" rows="3"
                  data-msg="Mohon input BPKB mobil yang Anda miliki, tipe mobil, dan tahun pembuatan."
                  placeholder="BPKB mobil yang Anda miliki, tipe mobil, dan tahun pembuatan"></textarea>
              ...
              <div class="form-row">
                ...
                <div class="col-lg-6 form-group">
                  ...
                  <input type="text" name="resultcaptchaMultiguna" placeholder="Jawaban Penjumlahan"
                    pattern="[0-9.RPrp]+" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Jawaban Penjumlahan'" required>
              ...
              <div class="text-center">
                ...
                <button class="mt-10 primary-btn d-inline-flex text-uppercase align-items-center"
                  onclick="return validateMultiguna();" type="submit">SUBMIT<span
  ...
  <a href="https://api.whatsapp.com/send?phone=6281289100640&text=Halo,%20Rana%20(Ramusen).%20Saya%20ingin%20info%20mengenai%20pengajuan%20Kredit%20Multiguna"
