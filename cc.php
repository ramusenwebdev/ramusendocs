  ...
  * License: https://bootstrapmade.com/license/
  ...
  <script>
    ...
    function validateCC() {
      ...
      window.open('https://api.whatsapp.com/send?phone=6281289100640&text=Halo%2C%20Rana%20%28Ramusen%29.%20Saya%20ingin%20info%20mengenai%20pengajuan%20' + 'Kartu%20Kredit' + '%3A%0D%0A%0D%0A-Nama%20Lengkap%3A%20' + document.forms["ccForm"]["applicant_name"].value + '%0D%0A-Nomor%20Handphone%3A%20' + document.forms["ccForm"]["mobile_number"].value + '%0D%0A-Nama%20Perusahaan%3A%20' + document.forms["ccForm"]["company_name"].value + '%0D%0A-Email%3A%20' + document.forms["ccForm"]["email"].value + '%0D%0A-Alamat%20Perusahaan%3A%20' + document.forms["ccForm"]["company_address"].value + '%0D%0A-Jabatan%3A%20' + document.forms["ccForm"]["job"].value + '%0D%0A-Penghasilan%20per%20Bulan%3A%20' + document.forms["ccForm"]["earnings_per_month"].value + '%0D%0A-Kartu Kredit%20yang%20sudah%20Anda%20miliki%3A%20' + document.forms["ccForm"]["cc"].value + '%20%0D%0A%0D%0ATerima%20Kasih', '_blank', 'resizable=yes');
...
<body>
    ...
    <section id="cc" class="contact">
      ...
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h2>
            <font color="#A62020">Gratis Iuran Tahunan Seumur Hidup.</font>
          </h2>
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
            ...
            <form id="ccForm" action="insert-cc.php" method="post" class="php-email-form">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="cc" rows="3" data-msg="Mohon input Kartu Kredit yang Anda miliki."
                  placeholder="Kartu Kredit yang Anda sudah Anda miliki"></textarea>
              ...
              <div class="form-row">
                ...
                <div class="col-lg-6 form-group">
                  ...
                  <input type="text" name="resultcaptchaCC" placeholder="Jawaban Penjumlahan" pattern="[0-9.RPrp]+"
              ...
              <div class="text-center">
                ...
                <button class="mt-10 primary-btn d-inline-flex text-uppercase align-items-center"
                  onclick="return validateCC();" type="submit">SUBMIT<span class="lnr lnr-arrow-right"></span></button>
  ...
  <a href="https://api.whatsapp.com/send?phone=6281289100640&text=Halo,%20Rana%20(Ramusen).%20Saya%20ingin%20info%20mengenai%20pengajuan%20Kartu%20Kredit"
